        ...
        return (
            <section id="midsection">
                <div className="container text-center">
                    ...
                    <div>
                    <iframe className="video" width="100%" height="560" src="https://www.youtube.com/embed/21u0ml7BePA?autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>
                    </div>
                </div>
